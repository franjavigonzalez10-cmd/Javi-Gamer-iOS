...
struct ThreeOneOSFiveApp: App {
    ...
    @StateObject private var licenseGate = LicenseGate()
        ...
        WindowGroup {
            ZStack {
                if licenseGate.isUnlocked {
                    ...
                    LicenseGateView(gate: licenseGate)
                }
            ...
            .onAppear {
                if !showOnboarding {
                    licenseGate.restoreStoredKey()
                }
                if !showOnboarding && licenseGate.isUnlocked {
            ...
            .onChange(of: scenePhase) { phase in
                ...
                if licenseGate.isUnlocked { appState.detectSupport() }
            }
            .onOpenURL { url in
                guard licenseGate.isUnlocked else { return }
